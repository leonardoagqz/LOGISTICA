...
procedure TFCadMeioTransporte.BtnCancelarKeyDown(Sender: TObject; var Key: Word; //procedimento botão ESC
  Shift: TShiftState);
begin                                                                     //inicie
...
begin                                                                       //inicie
  ...
  DM.sql_meiotransporte.Cancel;                                                  //cancela qualquer operação na tabela
end;                                                                        //fim
