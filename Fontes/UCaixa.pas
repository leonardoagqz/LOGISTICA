...
begin                                                 //inicie
  ...
  DM.sql_Caixa.Insert;
  DM.sql_CaixaDATA_CAIXA.AsDateTime:=Now;
  DM.sql_CaixaTIPO_CAIXA.AsString:='R';
  DM.sql_CaixaVALOR_CAIXA.AsFloat:=0;
  dm.CriarFormulario(TFCadCaixa,FCadCaixa);
  Self.Visible:=True;
...
procedure TFCaixa.BtnSairClick(Sender: TObject);//clique botão sair
begin
