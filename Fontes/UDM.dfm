object DM: TDM
  ...
  object SQL_acesso: TFDQuery
    ...
    Left = 32
    Top = 832
    object SQL_acessoACESSO_ID: TIntegerField
      FieldName = 'ACESSO_ID'
      Origin = 'ACESSO_ID'
    end
    object SQL_acessoACESSO_USER: TIntegerField
      FieldName = 'ACESSO_USER'
      Origin = 'ACESSO_USER'
    end
    object SQL_acessoACESSO_TELA: TIntegerField
      FieldName = 'ACESSO_TELA'
      Origin = 'ACESSO_TELA'
    end
    object SQL_acessoFORMS_ID: TIntegerField
      FieldName = 'FORMS_ID'
      Origin = 'FORMS_ID'
    end
    object SQL_acessoFORMS_NOME: TStringField
      FieldName = 'FORMS_NOME'
      Origin = 'FORMS_NOME'
      Size = 50
    end
    object SQL_acessoFORMS_DESCR: TStringField
      FieldName = 'FORMS_DESCR'
      Origin = 'FORMS_DESCR'
      Size = 50
    end
  end
  object sql_Gen_acesso: TFDQuery
    Connection = BDConnectionFB
    SQL.Strings = (
      'select gen_id(id_acesso,1)as id from rdb$database')
    Left = 128
    Top = 832
    object sql_Gen_acessoID: TLargeintField
      AutoGenerateValue = arDefault
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = []
